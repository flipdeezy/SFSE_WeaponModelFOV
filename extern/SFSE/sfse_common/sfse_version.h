...
#define RUNTIME_VERSION_1_6_35                                                 \
  MAKE_EXE_VERSION(                                                            \
      1, 6, 35) // 0x01060230	version reported by ms store before release
#define RUNTIME_VERSION_1_7_23                                                 \
  MAKE_EXE_VERSION(1, 7, 23) // 0x01070170	early access patch

#define PACKED_SFSE_VERSION                                                    \
  MAKE_EXE_VERSION(SFSE_VERSION_INTEGER, SFSE_VERSION_INTEGER_MINOR,           \
