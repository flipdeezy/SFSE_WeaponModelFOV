...
const char *kHook_ShowVersion_FormatString =
    "%08x v%s [SFSE " __PREPRO_TOKEN_STR__(SFSE_VERSION_INTEGER) "." __PREPRO_TOKEN_STR__(
        SFSE_VERSION_INTEGER_MINOR) "." __PREPRO_TOKEN_STR__(SFSE_VERSION_INTEGER_BETA) "]";
...
void Hooks_Version_Apply() {
  // show SFSE version in menu
  {
    ...
    g_branchTrampoline.write6Branch(kHook_ShowVersion_Offset.getUIntPtr(),
