...
#include <cpuid.h>
    ...
    defined(XBYAK32) // avoid err : can't find a register in class `BREG' while
                     // reloading `asm'
...
// -I /opt/intel/vtune_amplifier/include/ -L /opt/intel/vtune_amplifier/lib64
// -ljitprofiling -ldl
...
template <uint64_t L, uint64_t H = 0> struct TypeT {};

template <uint64_t L1, uint64_t H1, uint64_t L2, uint64_t H2>
XBYAK_CONSTEXPR TypeT<L1 | L2, H1 | H2> operator|(TypeT<L1, H1>,
                                                  TypeT<L2, H2>) {
  return TypeT<L1 | L2, H1 | H2>();
}

template <typename T> inline T max_(T x, T y) { return x >= y ? x : y; }
template <typename T> inline T min_(T x, T y) { return x < y ? x : y; }

} // namespace local

/**
        CPU detection class
        @note static inline const member is supported by c++17 or later, so use
   template hack
*/
class Cpu {
public:
  ...
  void setNumCores() {
     ...
     */
      ...
      */
      ...
      numCores_[CoreLevel - 1] =
          local::max_(numCores_[SmtLevel - 1], numCores_[CoreLevel - 1]);
    } else {
      /*
  ...
  void setCacheHierarchy() {
    ...
    if (has(tAMD)) {
      ...
      for (uint32_t sub_leaf = 0; sub_leaf <= dataCacheLevels_; sub_leaf++) {
        ...
        int actual_logical_cores =
            extractBit(data[0], 14, 25) /* # of cores * # of threads */ + 1;
        if (logical_cores != 0) {
          actual_logical_cores =
              local::min_(actual_logical_cores, logical_cores);
        }
        coresSharignDataCache_[cache_index] =
            local::max_(actual_logical_cores / smt_width, 1);
        ++cache_index;
      }
      return;
    }
    ...
    */
    for (int i = 0; dataCacheLevels_ < maxNumberCacheLevels; i++) {
      ...
      if (cacheType == DATA_CACHE || cacheType == UNIFIED_CACHE) {
        ...
        dataCacheSize_[dataCacheLevels_] = (extractBit(data[1], 22, 31) + 1) *
        ...
        coresSharignDataCache_[dataCacheLevels_] =
            local::max_(actual_logical_cores / smt_width, 1u);
        dataCacheLevels_++;
      }
    }
  }
...
public:
  ...
  uint32_t getCoresSharingDataCache(uint32_t i) const {
    if (i >= dataCacheLevels_)
      XBYAK_THROW_RET(ERR_BAD_PARAMETER, 0)
  ...
  */
  ...
  static inline void getCpuidEx(uint32_t eaxIn, uint32_t ecxIn,
                                uint32_t data[4]) {
#ifdef XBYAK_INTEL_CPU_SPECIFIC
#ifdef _WIN32
...
#define XBYAK_SPLIT_ID(id)                                                     \
  ((0 <= id && id < 64) ? (1ull << (id % 64)) : 0),                            \
      (id >= 64 ? (1ull << (id % 64)) : 0)
...
#else
#define XBYAK_DEFINE_TYPE(id, NAME)                                            \
  static const local::TypeT<XBYAK_SPLIT_ID(id)> NAME
#endif
  ...
  XBYAK_DEFINE_TYPE(22,
                    tBMI2); // bzhi, mulx, pdep, pext, rorx, sarx, shlx, shrx
  ...
  XBYAK_DEFINE_TYPE(
      43, tAVX512VBMI); // = tAVX512_VBMI; // changed by Intel's manual
...
#undef XBYAK_DEFINE_TYPE
  ...
  Cpu()
      : type_(), x2APIC_supported_(false), numCores_(), dataCacheSize_(),
        coresSharignDataCache_(), dataCacheLevels_(0) {
    uint32_t data[4] = {};
    ...
    if (type_ & tOSXSAVE) {
      ...
      if ((bv & 6) == 6) {
        ...
        if (ECX & (1U << 12))
          type_ |= tFMA;
          // do *not* check AVX-512 state on macOS because it has on-demand
          // AVX-512 support
#if !defined(__APPLE__)
        if (((bv >> 5) & 7) == 7)
#endif
...
public:
  ...
  Pack(const Xbyak::Reg64 &t6, const Xbyak::Reg64 &t5, const Xbyak::Reg64 &t4,
       const Xbyak::Reg64 &t3, const Xbyak::Reg64 &t2, const Xbyak::Reg64 &t1,
       const Xbyak::Reg64 &t0) {
    n_ = 7;
    tbl_[0] = t0;
    tbl_[1] = t1;
  ...
  Pack(const Xbyak::Reg64 &t7, const Xbyak::Reg64 &t6, const Xbyak::Reg64 &t5,
       const Xbyak::Reg64 &t4, const Xbyak::Reg64 &t3, const Xbyak::Reg64 &t2,
       const Xbyak::Reg64 &t1, const Xbyak::Reg64 &t0) {
    n_ = 8;
    tbl_[0] = t0;
    tbl_[1] = t1;
  ...
  Pack(const Xbyak::Reg64 &t8, const Xbyak::Reg64 &t7, const Xbyak::Reg64 &t6,
       const Xbyak::Reg64 &t5, const Xbyak::Reg64 &t4, const Xbyak::Reg64 &t3,
       const Xbyak::Reg64 &t2, const Xbyak::Reg64 &t1, const Xbyak::Reg64 &t0) {
    n_ = 9;
    tbl_[0] = t0;
    tbl_[1] = t1;
  ...
  Pack(const Xbyak::Reg64 &t9, const Xbyak::Reg64 &t8, const Xbyak::Reg64 &t7,
       const Xbyak::Reg64 &t6, const Xbyak::Reg64 &t5, const Xbyak::Reg64 &t4,
       const Xbyak::Reg64 &t3, const Xbyak::Reg64 &t2, const Xbyak::Reg64 &t1,
       const Xbyak::Reg64 &t0) {
    n_ = 10;
    tbl_[0] = t0;
  ...
  Pack(const Xbyak::Reg64 &ta, const Xbyak::Reg64 &t9, const Xbyak::Reg64 &t8,
       const Xbyak::Reg64 &t7, const Xbyak::Reg64 &t6, const Xbyak::Reg64 &t5,
       const Xbyak::Reg64 &t4, const Xbyak::Reg64 &t3, const Xbyak::Reg64 &t2,
       const Xbyak::Reg64 &t1, const Xbyak::Reg64 &t0) {
    n_ = 11;
    tbl_[0] = t0;
  ...
  Pack(const Xbyak::Reg64 &tb, const Xbyak::Reg64 &ta, const Xbyak::Reg64 &t9,
       const Xbyak::Reg64 &t8, const Xbyak::Reg64 &t7, const Xbyak::Reg64 &t6,
       const Xbyak::Reg64 &t5, const Xbyak::Reg64 &t4, const Xbyak::Reg64 &t3,
       const Xbyak::Reg64 &t2, const Xbyak::Reg64 &t1, const Xbyak::Reg64 &t0) {
    n_ = 12;
    tbl_[0] = t0;
...
public:
  ...
  /*
          ...
          @param tNum [in] num of temporary register(0 <= tNum, with UseRCX,
     UseRDX) #{pNum + tNum [+rcx] + [rdx]} <= 14
  ...
  */
  StackFrame(Xbyak::CodeGenerator *code, int pNum, int tNum = 0,
      ...
      : code_(code), pNum_(pNum), tNum_(tNum & ~(UseRCX | UseRDX)),
        useRcx_((tNum & UseRCX) != 0), useRdx_((tNum & UseRDX) != 0),
        saveNum_(0), P_(0), makeEpilog_(makeEpilog), p(p_), t(t_) {
    using namespace Xbyak;
    if (pNum < 0 || pNum > 4)
      XBYAK_THROW(ERR_BAD_PNUM)
    const int allRegNum = pNum + tNum_ + (useRcx_ ? 1 : 0) + (useRdx_ ? 1 : 0);
    if (tNum_ < 0 || allRegNum > maxRegNum)
      XBYAK_THROW(ERR_BAD_TNUM)
...
public:
  ...
  Profiler()
      : mode_(None), suffix_(""), startAddr_(0)
#ifdef XBYAK_USE_PERF
        ,
        fp_(0)
#endif
...
#ifdef XBYAK_USE_VTUNE
      dlopen("dummy",
             RTLD_LAZY); // force to load dlopen to enable jit profiling
  ...
  void set(const char *funcName, const void *startAddr, size_t funcSize) const {
    ...
    if (mode_ == Perf) {
      if (fp_ == 0)
        return;
      fprintf(fp_, "%llx %zx %s%s", (long long)startAddr, funcSize, funcName,
              suffix_);
      /*
